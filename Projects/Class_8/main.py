...
top_left2 = (width - 170, height - 170)
...
cv2.putText(image_rgb, 'Center 1', (top_left1[0], top_left1[1] - 10), font, 0.7, (0, 255, 0), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'Center 2', (top_left2[0], top_left2[1] - 10), font, 0.7, (0, 255, 0), 2, cv2.LINE_AA)
